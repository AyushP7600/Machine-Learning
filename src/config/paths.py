...
# DATA_PATH = os.path.abspath(os.path.join(BASE_DIR, '../src/data/trade_detailed_report.csv'))
DATA_PATH = os.path.abspath(os.path.join(BASE_DIR, '../src/data/full_trade_log.csv'))
